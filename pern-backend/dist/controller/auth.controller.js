...
const sendPasswordEmail_1 = require("../lib/sendPasswordEmail");
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        try {
            verificationMail = yield (0, sendEmail_1.sendVerificationEmail)(email, token);
        }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!user.verificationToken) {
                const createToken = yield dbConnect_1.prisma.emailVerificationToken.create({
                    data: {
                        userId: user.id,
                        token,
                ...
                yield (0, sendPasswordEmail_1.sendPasswordEmail)(user.email, token);
